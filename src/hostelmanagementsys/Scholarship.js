...
const CollapsibleListItem = () => {
    ...
    <span className=' text-yellow-400 w-full underline text-center'><h2>Pre matric Scholarship</h2></span>
    <Box  className='p-10 mt-4' sx={{ bgcolor: '#cfe8fc', height: 'full', }}>
    <p className='text-muted'>This scheme is a new Pre Matric Scholarship Scheme launched by Government of India for Scheduled Tribe students studying in IX & X in recognized institutions. The Government of India bears 100% of the total expenditure over and above the committed liability. Since, this is new Scheme launched in 2012-13, Committed Liability of state under this scheme will be fixed only in the next five year plan period</p>
    <ListGroup>
      <ListGroupItem color="success" className='cursor-pointer'onClick={toggleDetails}>
     {isExpanded ? '' :
       <IronIcon color="action" sx={{ fontSize: 40 }}/>} 
      </ListGroupItem>
      {isExpanded && (
            <ListGroupItem >
